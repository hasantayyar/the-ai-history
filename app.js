const ERAS = [
  { id: "foundations", label: "Foundations", short: "Foundations", range: "c. 350 BCEâ€“1899", start: -400, end: 1899 },
  { id: "formal", label: "Formal computation", short: "Formal computation", range: "1900â€“1955", start: 1900, end: 1955 },
  { id: "birth", label: "Birth of AI", short: "Birth of AI", range: "1956â€“1969", start: 1956, end: 1969 },
  { id: "symbolic", label: "Systems & winters", short: "Systems + winters", range: "1970â€“1992", start: 1970, end: 1992 },
  { id: "statistical", label: "Statistical learning", short: "Statistical ML", range: "1993â€“2011", start: 1993, end: 2011 },
  { id: "deep", label: "Deep learning takeoff", short: "Deep learning", range: "2012â€“2017", start: 2012, end: 2017 },
  { id: "foundation", label: "Foundation models", short: "Foundation models", range: "2018â€“2021", start: 2018, end: 2021 },
  { id: "boom", label: "Generative AI boom", short: "Generative boom", range: "2022â€“2025", start: 2022, end: 2025 }
];
...
const EVENTS = [
  {
    ...
    significance: "It establishes the durable idea that reasoning can be represented by explicit rulesâ€”a premise underneath symbolic AI and automated theorem proving.",
    source: "Stanford Encyclopedia of Philosophy Â· Aristotleâ€™s Logic", sourceUrl: "https://plato.stanford.edu/entries/aristotle-logic/"
  },
  {
    ...
    summary: "Llullâ€™s Ars Magna uses rotating symbolic figures to combine concepts and mechanically generate propositions.",
    ...
    source: "Stanford Encyclopedia of Philosophy Â· Ramon Llull", sourceUrl: "https://plato.stanford.edu/entries/llull/"
  },
  {
    ...
    source: "Project Gutenberg Â· The English Works of Thomas Hobbes", sourceUrl: "https://www.gutenberg.org/ebooks/73906"
  },
  {
    ...
    source: "Stanford Encyclopedia of Philosophy Â· Leibnizâ€™s Logic", sourceUrl: "https://plato.stanford.edu/entries/leibniz-logic-influence/"
  },
  {
    ...
    source: "Project Gutenberg Â· An Investigation of the Laws of Thought", sourceUrl: "https://www.gutenberg.org/ebooks/15114"
  },
  {
    ...
    source: "Stanford Encyclopedia of Philosophy Â· Fregeâ€™s Logic", sourceUrl: "https://plato.stanford.edu/entries/frege/"
  },
  {
    ...
    source: "Encyclopedia of Mathematics Â· Markov chain", sourceUrl: "https://encyclopediaofmath.org/wiki/Markov_chain"
  },
  {
    id: "godel-incompleteness", year: 1931, displayYear: "1931", era: "formal", theme: "Logic & computation",
    title: "GÃ¶del identifies limits of formal systems",
    ...
    source: "Stanford Encyclopedia of Philosophy Â· GÃ¶delâ€™s Incompleteness Theorems", sourceUrl: "https://plato.stanford.edu/entries/goedel-incompleteness/"
  },
  {
    ...
    significance: "The universal Turing machine provides the conceptual basis for programmable computersâ€”and for software capable of implementing AI methods.",
    source: "Proceedings of the London Mathematical Society Â· On Computable Numbers", sourceUrl: "https://doi.org/10.1112/plms/s2-42.1.230"
  },
  {
    ...
    source: "Bulletin of Mathematical Biophysics Â· A Logical Calculus", sourceUrl: "https://doi.org/10.1007/BF02478259"
  },
  {
    ...
    source: "Institute for Advanced Study Â· First Draft of a Report on the EDVAC", sourceUrl: "https://library.ias.edu/files/pdfs/ecp/firstdraft.pdf"
  },
  {
    ...
    source: "MIT Press Â· Cybernetics", sourceUrl: "https://mitpress.mit.edu/9780262730099/cybernetics/"
  },
  {
    ...
    source: "Bell System Technical Journal Â· A Mathematical Theory of Communication", sourceUrl: "https://doi.org/10.1002/j.1538-7305.1948.tb01338.x"
  },
  {
    ...
    source: "Internet Archive Â· The Organization of Behavior", sourceUrl: "https://archive.org/details/organizationofbe00hebb"
  },
  {
    id: "turing-test", year: 1950, displayYear: "1950", era: "formal", theme: "Governance & society",
    title: "Turing proposes the imitation game",
    summary: "Instead of defining intelligence, Turing asks whether a machineâ€™s conversation can be distinguished from a humanâ€™s.",
    ...
    source: "Mind Â· Computing Machinery and Intelligence", sourceUrl: "https://doi.org/10.1093/mind/LIX.236.433"
  },
  {
    ...
    source: "MIT CSAIL Â· Marvin Minsky biography", sourceUrl: "https://www.csail.mit.edu/person/marvin-minsky"
  },
  {
    ...
    source: "Dartmouth Â· Artificial Intelligence Coined at Dartmouth", sourceUrl: "https://home.dartmouth.edu/about/artificial-intelligence-ai-coined-dartmouth"
  },
  {
    ...
    source: "RAND Â· The Logic Theory Machine", sourceUrl: "https://www.rand.org/pubs/papers/P868.html"
  },
  {
    ...
    source: "Cornell Aeronautical Laboratory Â· The Perceptron", sourceUrl: "https://apps.dtic.mil/sti/pdfs/AD0256582.pdf"
  },
  {
    ...
    source: "Communications of the ACM Â· Recursive Functions of Symbolic Expressions", sourceUrl: "https://doi.org/10.1145/367177.367199"
  },
  {
    id: "samuel-machine-learning", year: 1959, displayYear: "1959", era: "birth", theme: "Robotics & games",
    title: "Arthur Samuel popularizes â€œmachine learningâ€",
    summary: "Samuelâ€™s checkers program improves through experience and searches game positions with learned evaluations.",
    ...
    source: "IBM Journal Â· Some Studies in Machine Learning Using the Game of Checkers", sourceUrl: "https://doi.org/10.1147/rd.33.0210"
  },
  {
    ...
    source: "Stanford Â· Adaptive Switching Circuits", sourceUrl: "https://isl.stanford.edu/~widrow/papers/c1960adaptiveswitching.pdf"
  },
  {
    ...
    source: "International Federation of Robotics Â· The history of industrial robots", sourceUrl: "https://ifr.org/robot-history"
  },
  {
    ...
    source: "Stanford Â· DENDRAL", sourceUrl: "https://exhibits.stanford.edu/feigenbaum/catalog/nz422hf0293"
  },
  {
    id: "eliza", year: 1966, displayYear: "1966", era: "birth", theme: "Language",
    title: "ELIZA simulates conversation",
    summary: "Joseph Weizenbaumâ€™s program uses pattern matching and scripted transformations to imitate a psychotherapist.",
    ...
    source: "Communications of the ACM Â· ELIZA", sourceUrl: "https://doi.org/10.1145/365153.365168"
  },
  {
    ...
    source: "IEEE Transactions on Information Theory Â· Nearest Neighbor Pattern Classification", sourceUrl: "https://doi.org/10.1109/TIT.1967.1053964"
  },
  {
    id: "shakey", year: 1969, displayYear: "1966â€“72", era: "birth", theme: "Robotics & games",
    title: "Shakey integrates perception, planning, and action",
    summary: "SRIâ€™s mobile robot navigates rooms, perceives simple objects, and plans multi-step actions from goals.",
    significance: "Shakey is the first general-purpose mobile robot to combine major AI subsystems in one embodied agent.",
    source: "SRI International Â· Shakey the Robot", sourceUrl: "https://www.sri.com/hoi/shakey-the-robot/"
  },
  {
    ...
    significance: "The critique is mathematically valuable, butâ€”alongside funding and hardware limitsâ€”helps cool enthusiasm for neural-network research.",
    source: "MIT Press Â· Perceptrons", sourceUrl: "https://mitpress.mit.edu/9780262631112/perceptrons/"
  },
  {
    ...
    source: "Association for Logic Programming Â· The Birth of Prolog", sourceUrl: "https://www.cs.cmu.edu/afs/cs/project/ai-repository/ai/lang/prolog/doc/history/birthpl.pdf"
  },
  {
    id: "mycin", year: 1972, displayYear: "1972â€“76", era: "symbolic", theme: "Logic & computation",
    ...
    source: "Stanford Â· MYCIN experiments", sourceUrl: "https://exhibits.stanford.edu/feigenbaum/catalog/hh848gb7264"
  },
  {
    ...
    summary: "A UK government review criticizes AIâ€™s practical results and difficulty scaling beyond toy problems.",
    ...
    source: "UK Parliament Â· Artificial Intelligence report", sourceUrl: "https://api.parliament.uk/historic-hansard/lords/1973/dec/19/artificial-intelligence"
  },
  {
    ...
    summary: "Werbosâ€™s dissertation proposes efficiently propagating errors backward through layered systems to compute gradients.",
    ...
    source: "Harvard DASH Â· Beyond Regression", sourceUrl: "https://dash.harvard.edu/handle/1/39006405"
  },
  {
    ...
    source: "Stanford AI Lab Â· The Stanford Cart", sourceUrl: "https://web.stanford.edu/~learnest/cart.htm"
  },
  {
    ...
    significance: "XCONâ€™s commercial savings trigger an expert-systems boom and demonstrate that narrow encoded expertise can create business value.",
    source: "AAAI Â· R1: An Expert in the Computer Systems Domain", sourceUrl: "https://ojs.aaai.org/aimagazine/index.php/aimagazine/article/view/99"
  },
  {
    ...
    source: "PNAS Â· Neural networks and physical systems", sourceUrl: "https://doi.org/10.1073/pnas.79.8.2554"
  },
  {
    ...
    source: "Nature Â· Learning representations by back-propagating errors", sourceUrl: "https://doi.org/10.1038/323533a0"
  },
  {
    id: "second-ai-winter", year: 1987, displayYear: "1987â€“93", era: "symbolic", theme: "Governance & society",
    ...
    source: "AI Magazine Â· AI: The Tumultuous History", sourceUrl: "https://ojs.aaai.org/aimagazine/index.php/aimagazine/article/view/1842"
  },
  {
    ...
    source: "Morgan Kaufmann Â· Probabilistic Reasoning in Intelligent Systems", sourceUrl: "https://www.sciencedirect.com/book/9781558604797/probabilistic-reasoning-in-intelligent-systems"
  },
  {
    ...
    source: "Neural Computation Â· Backpropagation Applied to Handwritten Zip Code Recognition", sourceUrl: "https://doi.org/10.1162/neco.1989.1.4.541"
  },
  {
    ...
    source: "University of Cambridge Â· Learning from Delayed Rewards", sourceUrl: "http://www.cs.rhul.ac.uk/~chrisw/new_thesis.pdf"
  },
  {
    ...
    source: "Machine Learning Â· Support-vector networks", sourceUrl: "https://doi.org/10.1007/BF00994018"
  },
  {
    ...
    source: "Neural Computation Â· Long Short-Term Memory", sourceUrl: "https://doi.org/10.1162/neco.1997.9.8.1735"
  },
  {
    ...
    summary: "IBMâ€™s specialized system beats Garry Kasparov in a six-game match using massive search and expert-designed evaluation.",
    ...
    source: "IBM Â· Deep Blue", sourceUrl: "https://www.ibm.com/history/deep-blue"
  },
  {
    ...
    significance: "LeNet-5 establishes durable CNN building blocksâ€”convolution, subsampling, and end-to-end gradient trainingâ€”years before the deep-learning boom.",
    source: "Proceedings of the IEEE Â· Gradient-Based Learning Applied to Document Recognition", sourceUrl: "https://doi.org/10.1109/5.726791"
  },
  {
    ...
    source: "Machine Learning Â· Random Forests", sourceUrl: "https://doi.org/10.1023/A:1010933404324"
  },
  {
    ...
    source: "Google Research Â· MapReduce", sourceUrl: "https://research.google/pubs/mapreduce-simplified-data-processing-on-large-clusters/"
  },
  {
    ...
    source: "Neural Computation Â· A Fast Learning Algorithm for Deep Belief Nets", sourceUrl: "https://doi.org/10.1162/neco.2006.18.7.1527"
  },
  {
    ...
    source: "NVIDIA Â· CUDA history", sourceUrl: "https://developer.nvidia.com/cuda-zone"
  },
  {
    ...
    significance: "ImageNet creates a shared benchmark where data, compute, and algorithms can compoundâ€”and makes the 2012 deep-learning breakthrough measurable.",
    source: "CVPR Â· ImageNet: A Large-Scale Hierarchical Image Database", sourceUrl: "https://doi.org/10.1109/CVPR.2009.5206848"
  },
  {
    ...
    source: "IBM Â· Watson on Jeopardy!", sourceUrl: "https://www.ibm.com/history/watson-jeopardy"
  },
  {
    ...
    source: "NeurIPS Â· ImageNet Classification with Deep Convolutional Neural Networks", sourceUrl: "https://papers.nips.cc/paper/4824-imagenet-classification-with-deep-convolutional-neural-networks"
  },
  {
    ...
    source: "Google Research Â· Efficient Estimation of Word Representations", sourceUrl: "https://research.google/pubs/efficient-estimation-of-word-representations-in-vector-space/"
  },
  {
    ...
    source: "NeurIPS Â· Sequence to Sequence Learning with Neural Networks", sourceUrl: "https://papers.nips.cc/paper/5346-sequence-to-sequence-learning-with-neural-networks"
  },
  {
    ...
    source: "arXiv Â· Neural Machine Translation by Jointly Learning to Align and Translate", sourceUrl: "https://arxiv.org/abs/1409.0473"
  },
  {
    ...
    source: "NeurIPS Â· Generative Adversarial Nets", sourceUrl: "https://papers.nips.cc/paper/5423-generative-adversarial-nets"
  },
  {
    ...
    source: "Nature Â· Human-level control through deep reinforcement learning", sourceUrl: "https://doi.org/10.1038/nature14236"
  },
  {
    ...
    source: "CVPR Â· Deep Residual Learning for Image Recognition", sourceUrl: "https://doi.org/10.1109/CVPR.2016.90"
  },
  {
    id: "alphago", year: 2016, displayYear: "2016", era: "deep", theme: "Robotics & games",
    title: "AlphaGo defeats Lee Sedol",
    summary: "Policy and value networks combine with tree search to defeat one of the worldâ€™s strongest Go players.",
    ...
    source: "Nature Â· Mastering the game of Go with deep neural networks and tree search", sourceUrl: "https://doi.org/10.1038/nature16961"
  },
  {
    ...
    source: "NeurIPS Â· Attention Is All You Need", sourceUrl: "https://papers.nips.cc/paper/7181-attention-is-all-you-need"
  },
  {
    ...
    source: "OpenAI Â· Improving Language Understanding by Generative Pre-Training", sourceUrl: "https://cdn.openai.com/research-covers/language-unsupervised/language_understanding_paper.pdf"
  },
  {
    ...
    source: "Google Research Â· BERT", sourceUrl: "https://research.google/pubs/bert-pre-training-of-deep-bidirectional-transformers-for-language-understanding/"
  },
  {
    ...
    significance: "Its surprising fluency makes general-purpose text generationâ€”and the governance of model releaseâ€”a public issue.",
    source: "OpenAI Â· Better Language Models and Their Implications", sourceUrl: "https://openai.com/index/better-language-models/"
  },
  {
    ...
    source: "OpenAI Â· Scaling Laws for Neural Language Models", sourceUrl: "https://arxiv.org/abs/2001.08361"
  },
  {
    ...
    source: "NeurIPS Â· Language Models are Few-Shot Learners", sourceUrl: "https://papers.nips.cc/paper/2020/hash/1457c0d6bfcb4967418bfb8ac142f64a-Abstract.html"
  },
  {
    ...
    source: "NeurIPS Â· Retrieval-Augmented Generation", sourceUrl: "https://papers.nips.cc/paper/2020/hash/6b493230205f780e1bc26945df7481e5-Abstract.html"
  },
  {
    ...
    source: "NeurIPS Â· Denoising Diffusion Probabilistic Models", sourceUrl: "https://papers.nips.cc/paper/2020/hash/4c5bcfec8584af0d967f1ab10179ca4b-Abstract.html"
  },
  {
    ...
    summary: "DeepMindâ€™s system predicts many protein structures from amino-acid sequences with near-experimental accuracy.",
    ...
    source: "Nature Â· Highly accurate protein structure prediction with AlphaFold", sourceUrl: "https://doi.org/10.1038/s41586-021-03819-2"
  },
  {
    id: "clip", year: 2021, displayYear: "2021", era: "foundation", theme: "Vision",
    title: "CLIP aligns images and natural language",
    summary: "CLIP learns visual concepts from hundreds of millions of imageâ€“text pairs and transfers to new classification tasks from text prompts.",
    ...
    source: "OpenAI Â· CLIP", sourceUrl: "https://openai.com/index/clip/"
  },
  {
    id: "dall-e", year: 2021, displayYear: "2021", era: "foundation", theme: "Generative AI",
    title: "DALLÂ·E turns text into novel images",
    ...
    source: "OpenAI Â· DALLÂ·E", sourceUrl: "https://openai.com/index/dall-e/"
  },
  {
    id: "foundation-models", year: 2021, displayYear: "2021", era: "foundation", theme: "Governance & society",
    title: "â€œFoundation modelâ€ names a new paradigm",
    ...
    source: "Stanford CRFM Â· On the Opportunities and Risks of Foundation Models", sourceUrl: "https://arxiv.org/abs/2108.07258"
  },
  {
    ...
    significance: "The work redirects the field toward better dataâ€“model balance, making capable models smaller and more compute-efficient at inference time.",
    source: "NeurIPS Â· Training Compute-Optimal Large Language Models", sourceUrl: "https://papers.nips.cc/paper_files/paper/2022/hash/c1e2faff6f588870935f114ebe04a3e5-Abstract-Conference.html"
  },
  {
    ...
    source: "NeurIPS Â· Training language models to follow instructions with human feedback", sourceUrl: "https://papers.nips.cc/paper_files/paper/2022/hash/b1efde53be364a73914f58805a001731-Abstract-Conference.html"
  },
  {
    ...
    source: "CVPR Â· High-Resolution Image Synthesis with Latent Diffusion Models", sourceUrl: "https://doi.org/10.1109/CVPR52688.2022.01042"
  },
  {
    ...
    source: "ICLR Â· ReAct: Synergizing Reasoning and Acting", sourceUrl: "https://openreview.net/forum?id=WE_vluYUL-X"
  },
  {
    ...
    source: "OpenAI Â· Introducing ChatGPT", sourceUrl: "https://openai.com/index/chatgpt/"
  },
  {
    ...
    source: "OpenAI Â· GPT-4 Technical Report", sourceUrl: "https://arxiv.org/abs/2303.08774"
  },
  {
    ...
    source: "Meta AI Â· LLaMA", sourceUrl: "https://arxiv.org/abs/2302.13971"
  },
  {
    ...
    source: "NeurIPS Â· Direct Preference Optimization", sourceUrl: "https://papers.nips.cc/paper_files/paper/2023/hash/a85b405ed65c6477a4fe8302b5e06ce7-Abstract-Conference.html"
  },
  {
    ...
    source: "Google DeepMind Â· Gemini", sourceUrl: "https://deepmind.google/models/gemini/"
  },
  {
    ...
    source: "European Commission Â· AI Act", sourceUrl: "https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai"
  },
  {
    ...
    source: "OpenAI Â· Hello GPT-4o", sourceUrl: "https://openai.com/index/hello-gpt-4o/"
  },
  {
    ...
    source: "OpenAI Â· Learning to reason with LLMs", sourceUrl: "https://openai.com/index/learning-to-reason-with-llms/"
  },
  {
    ...
    source: "Anthropic Â· Introducing the Model Context Protocol", sourceUrl: "https://www.anthropic.com/news/model-context-protocol"
  },
  {
    ...
    source: "Nature Â· DeepSeek-R1 incentivizes reasoning in LLMs through reinforcement learning", sourceUrl: "https://doi.org/10.1038/s41586-025-09422-z"
  }
...
function populateFilters() {
  ERAS.forEach(era => els.era.add(new Option(`${era.label} Â· ${era.range}`, era.id)));
...
function renderData(events) {
  ...
  events.forEach(event => {
    ...
    row.innerHTML = `<td>${event.displayYear}</td><td><strong>${event.title}</strong><br>${event.summary}</td><td>${event.theme}</td><td>${era.label}</td><td><a href="${event.sourceUrl}" target="_blank" rel="noreferrer">${event.source} â†—</a></td>`;
    fragment.append(row);
  });
...
function render() {
  ...
  if (events.length) {
    els.activeRange.textContent = `${formatYear(events[0].year)}â€”${formatYear(events.at(-1).year)}`;
  } else {
...
function openEvent(id) {
  ...
  els.dialogSource.textContent = `${event.source} â†—`;
