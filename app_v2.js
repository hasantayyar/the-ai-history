const ERAS = [
  { id: "foundations", label: "Foundations", short: "Foundations", range: "c. 400 BCE–1899", start: -400, end: 1899 },
...
const EVENTS = [
  {
    id: "panini-astadhyayi", year: -400, displayYear: "c. 400 BCE", era: "foundations", theme: "Language",
    title: "Pāṇini writes a generative grammar of Sanskrit",
    summary: "The Aṣṭādhyāyī encodes Sanskrit morphology and syntax as a compact system of production-like rules, meta-rules, and ordered operations.",
    significance: "It is an early, unusually complete formal grammar: language is generated by explicit rules rather than listed as examples, a lineage later linguists and computer scientists would recognize as generative.",
    source: "Stanford Encyclopedia of Philosophy · Language in Classical Indian Philosophy", sourceUrl: "https://plato.stanford.edu/entries/language-india/"
  },
  {
  ...
  {
    id: "euclid-algorithm", year: -300, displayYear: "c. 300 BCE", era: "foundations", theme: "Logic & computation",
    title: "Euclid records a general procedure for greatest common divisors",
    summary: "In the Elements, Euclid describes a finite, repeatable method that finds the greatest common divisor of two numbers by successive remainder steps.",
    significance: "The Euclidean algorithm is a canonical early example of an algorithm: a definite procedure that terminates with a correct result, independent of any particular pair of inputs.",
    source: "Clark University · Euclid’s Elements, Book VII, Proposition 2", sourceUrl: "https://mathcs.clarku.edu/~djoyce/elements/bookVII/propVII2.html"
  },
  {
    id: "al-jazari-automata", year: 1206, displayYear: "1206", era: "foundations", theme: "Robotics & games",
    title: "al-Jazari documents programmable automata",
    summary: "In The Book of Knowledge of Ingenious Mechanical Devices, Ismail al-Jazari describes water-powered machines, including musical automata whose sequences could be changed by rearranging pegs.",
    significance: "The designs treat behavior as something that can be encoded and altered in a mechanism, an early documented step toward programmable machines rather than fixed one-purpose devices.",
    source: "Internet Archive · The Book of Knowledge of Ingenious Mechanical Devices", sourceUrl: "https://archive.org/details/TheBookOfKnowledgeOfIngeniousMechaniIbnAlRazzazAlJazari"
  },
  {
